  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 flex flex-col md:p-12 relative overflow-hidden">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-800 pb-6 mb-8 max-w-6xl w-full mx-auto">
        <div>
          <span className="text-xs font-semibold text-blue-500 bg-blue-500/10 px-2.5 py-1 rounded-full uppercase tracking-wider">
            Seller Area
          </span>
      ...
      <main className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full mx-auto">
        ...
        <section className="bg-slate-900/40 border border-slate-800 rounded-xl p-6 backdrop-blur">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <span className="inline-block bg-blue-500/20 text-blue-300 text-xs px-2 py-0.5 rounded font-mono mt-1">
        ...
        <section className="bg-slate-900/40 border border-slate-800 rounded-xl p-6 backdrop-blur md:col-span-2 flex flex-col justify-between">
          <div>
            <h3 className="text-lg font-bold text-slate-200 mb-2 font-sans">Welcome, Seller!</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              As a seller, you can create and manage quotations, place new orders, view existing orders, and check inventory stock levels.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="bg-slate-950/50 border border-slate-900 p-4 rounded-lg">
              <span className="text-2xl font-bold text-blue-500">Sales</span>
              <p className="text-xs text-slate-400 mt-1">Ready for input</p>
            </div>
            <div className="bg-slate-950/50 border border-slate-900 p-4 rounded-lg">
              <span className="text-2xl font-bold text-indigo-500">Orders</span>
              <p className="text-xs text-slate-400 mt-1">Fulfillment queue</p>
            </div>
          </div>
        </section>
      </main>
